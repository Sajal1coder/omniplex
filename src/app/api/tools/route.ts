...
export async function POST(req: Request) {
  ...
  const tools: OpenAI.Chat.Completions.ChatCompletionTool[] = [
    ...
    // Add more functions as needed
    {
      ...
      "function": {
        "name": "linkedin",
        "description": "Get LinkedIn profile information for a given email address",
        "parameters": {
          "type": "object",
          "properties": {
            "email": {
              "type": "string",
              "description": "Email address associated with the LinkedIn profile to fetch information for."
            }
          },
          "required": ["email"]
        }
